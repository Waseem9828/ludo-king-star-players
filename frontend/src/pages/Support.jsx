    ...
    <div className="support-page-container">
      <div className="support-card">
        ...
        <div className="support-card-header">
          <h1 className="support-header-title">Help & Support</h1>
          <p className="support-header-subtitle">
            Need help with deposits, withdrawals, or matches? Reach out to our 24/7 customer care!
          </p>
        </div>
        ...
        <div className="support-image-wrapper">
          <img 
            ...
            className="support-banner-image" 
          />
        </div>
